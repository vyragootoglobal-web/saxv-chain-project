...
def sync_chain():
    ...
    for node in nodes:
        try:
            ...
            pass
    threading.Timer(10.0, sync_chain).start()  # sync tiap 10 detik
...
def run_gui():
    root = tk.Tk()
    root.title("SAXV Node V9 GUI Multi-Node")
    ...
    tk.Button(root,text="Mine Block",command=mine_block_gui,bg="green",fg="white").pack(pady=5)
    ...
    tk.Button(frame_tx,text="Send SAXV",command=send_saxv_gui,bg="blue",fg="white").grid(row=2,column=0,columnspan=2,pady=5)
